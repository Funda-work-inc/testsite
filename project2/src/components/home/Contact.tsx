      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <FadeInSection direction="up">
            <div>
              <h2 className="heading-lg mb-8">Visit Us</h2>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-cream-light">123 Coffee Street, Tokyo, Japan</p>
                    <p className="text-cream-light">Near Central Station, 5-minute walk from Exit 3</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-cream-light">Monday - Friday: 7:30 AM - 9:00 PM</p>
                    <p className="text-cream-light">Saturday - Sunday: 8:00 AM - 10:00 PM</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-cream-light">Phone: +81 3-1234-5678</p>
                    <p className="text-cream-light">Email: hello@cinnamoncafe.com</p>
                  </div>
                </div>
              </div>
