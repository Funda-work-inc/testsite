        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="text-xl font-serif font-bold">Cinnamon Cafe</span>
            </div>
            <p className="text-cream-light">
              A cozy space where premium coffee meets homemade pastries and a warm, inviting atmosphere.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span>123 Coffee Street, Tokyo, Japan</span>
              </li>
